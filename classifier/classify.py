...
if __name__ == "__main__":
    ...
    DB_CONFIG = {
        ...
        "database": os.environ.get("PGDATABASE", "vv8_backend"),
    ...
    MODEL_PATH = os.environ.get(
        ...
        "final_models/behavioral_biometric_classifier_binary_20250711_161434.pkl",
    )
    SOURCE_TABLE = os.environ.get("CLASSIFIER_SOURCE_TABLE", "multicore_static_info")
    RESULTS_TABLE = os.environ.get("CLASSIFIER_RESULTS_TABLE", "rf_classification_results")
    VIEW_NAME = os.environ.get("CLASSIFIER_VIEW_NAME", "rf_classification_view")
    LIMIT = int(os.environ["CLASSIFIER_LIMIT"]) if os.environ.get("CLASSIFIER_LIMIT") else None
